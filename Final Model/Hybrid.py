...
model = keras.models.load_model("./output/hybrid_model_best.keras")
...
class HybridClassifierApp(QWidget):
    def __init__(self):
        ...
        left_layout.addWidget(QLabel("<h3 style='color: #ecf0f1;'>CBAM Attention Map</h3>"))
        ...
        try:
            ...
            for i, class_name in enumerate(CLASS_NAMES):
                if predictions[i] > 0.5:
                    detected_diseases.append((class_name, predictions[i]))
            ...
            if detected_diseases:
                ...
                for disease, confidence in detected_diseases:
                    disease_label = QLabel(
                        ...
                        f"<h3 style='color: #e74c3c; margin: 0;'>{disease}</h3>"
